...
<main class="container mt-4">
	...
	<div class="row">
		...
		<div class="col-md-4 mb-4 p-5 m-0 pt-auto pb-1">
			<div class="card">
				<img src="math_course3.jpg" class="card-img-top" alt="Math Course 3">
				<div class="card-body">
					<h5 class="card-title">統計學基礎課程</h5>
					<p class="card-text">歡迎加入我們的統計學基礎課程，這是一個為初學者準備的課程，將帶你深入了解統計學的基本概念和應用。<br>
					    無論你是準備進入統計學領域還是想提升自己的統計學知識，這個課程都是你的最佳選擇。<br>
						課程亮點： 基礎理論掌握： 學習統計學的基本理論，包括概率、假設檢定、回歸分析等核心內容。<br>
